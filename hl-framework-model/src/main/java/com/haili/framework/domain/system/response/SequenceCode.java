...
public enum SequenceCode implements ResultCode {
    ...
    SEQUENCE_CANNOT_DETERMINE_BIZ_NAME(false, 23101, "无法确定编码序列所关联业务！"),
    SEQUENCE_CANNOT_DETERMINE_CODE_RULE(false, 23102, "无法确定编码规则！"),
    SEQUENCE_CANNOT_RESOLVE_MIN_OR_MAX(false, 23103, "无法解析序列最小值或最大值！"),
    SEQUENCE_CANNOT_RESOLVE_FIRST_DAY_OF_WEEK(false, 23104, "无法解析星期首日！"),
    SEQUENCE_MAXIMUM_EXCEEDED(false, 23105, "超出序列最大值！"),
    SEQUENCE_FIRST_DAY_OF_WEEK_NOT_DETERMINED(false, 23106, "未确定星期首日！");
