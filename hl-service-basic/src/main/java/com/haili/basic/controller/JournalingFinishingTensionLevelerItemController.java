...
public class JournalingFinishingTensionLevelerItemController extends JournalingBaseController<JournalingFinishingTensionLevelerItem> {
    ...
    @Override
    @PreAuthorize("hasAnyAuthority('finishingtensionleveler_split_raw_item_add','finishingtensionleveler_split_raw_item_update')")
    ...
    @Override
    @PreAuthorize("hasAuthority('finishingtensionleveler_split_raw_item_submit')")
    ...
    @Override
    @PreAuthorize("hasAuthority('finishingtensionleveler_split_raw_item_revoke')")
    ...
    @Override
    @PreAuthorize("hasAuthority('finishingtensionleveler_split_raw_item_delete')")
